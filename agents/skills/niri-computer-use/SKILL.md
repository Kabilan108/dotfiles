...
|---|---|
| Web page / web app | Use an available, suitable integrated browser; otherwise use `agent-browser` headlessly. Use `helium-browser-use` for an intentionally shared Helium session or its saved logins. |
