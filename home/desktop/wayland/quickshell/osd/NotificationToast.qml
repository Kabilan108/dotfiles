...
Item {
    ...
    property string accentColor: root.isCritical ? Theme.red
                                : root.isLow ? Theme.overlay0
                                : Theme.blue
    ...
    Rectangle {
        ...
        border.color: root.isCritical ? Qt.rgba(1, 0.3, 0.3, 0.3) : Theme.panelBorder
    ...
    // === Inline mode (notification center) ===
    RowLayout {
        id: inlineContent
        visible: root.inline
        anchors {
