...
-- telescope
utils.map("<leader>b", "n", function() ts.buffers({ sort_mru = true }) end, "search buffers")
utils.map(
  "<leader>sf", "n",
  function()
    ts.find_files({
...
-- harpoon
utils.map("<leader>a", "n", function() harpoon:list():add() end, "add harpoon")
utils.map("<leader>h", "n", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end, "list harpoons")
utils.map("<leader>1", "n", function() harpoon:list():select(1) end)
utils.map("<leader>2", "n", function() harpoon:list():select(2) end)
utils.map("<leader>3", "n", function() harpoon:list():select(3) end)
utils.map("<leader>4", "n", function() harpoon:list():select(4) end)
utils.map("<C-P>", "n", function() harpoon:list():prev() end)
utils.map("<C-N>", "n", function() harpoon:list():next() end)
harpoon:extend({
...
utils.map("dr", "n", dap.run_to_cursor, "run to cursor")
utils.map("dv", "n", function() require("dapui").eval(nil, { enter = true }) end, "check value")
